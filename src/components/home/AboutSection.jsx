    ...
    <div className="about-section">
             <div className="inner-row">
                          ...
                          <div className="benefits-section">
                                     <div className="benefits-section-column" data-aos="zoom-in-right">
                                                <h4 className="intro">Why Us</h4>
                                                <h2>Experience the Edge that Sets Us Apart.</h2>
                                     </div>
                                     <div className="benefits-section-column grid" >
